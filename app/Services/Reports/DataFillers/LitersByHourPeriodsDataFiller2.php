...
class LitersByHourPeriodsDataFiller2
{
    ...
    private $user;
    private $isAdmin;
    private LitersPeriodsReport $report;
    private $startPeriod;
    private $endPeriod;

    public function __construct($datePeriod, $hourPeriods, $user, $isAdmin, LitersPeriodsReport $report)
    {
