...
class LitersByHourPeriodsDeviceDataFiller2
{
    ...
    private $user;
    private $isAdmin;
    private LitersPeriodsDeviceReport $report;
    private $startPeriod;
    private $endPeriod;

    public function __construct($datePeriod, $hourPeriods, $user, $isAdmin, LitersPeriodsDeviceReport $report)
    {
